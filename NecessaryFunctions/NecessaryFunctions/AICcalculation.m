function [AIC_pred] = AICcalculation(n, x_matrix, K, Q, d, mu, tau, sigma2)
...
%The user specify mu, tau, and sigma^2 = variance. 
...
gconstraint = repmat(1e-4,[J-1,1]);  %CVX doesn't like strict inequalities 
