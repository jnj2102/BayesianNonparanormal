function [L1_SSVS_save,SP_SSVS_total, SE_SSVS_total, MCC_SSVS_total, edge_matrix_ssvs, q_iters,...
...
%graphical model method.  Does BDA version of Rhat with split chains, finds WBIC. Joint
%algorithm version.
...
%find the loss function using SSVS
    ...
    L1_SSVS_save = trace(Omega_L1_SSVS*sigma_true) - log(det(Omega_L1_SSVS*sigma_true)) - p;
