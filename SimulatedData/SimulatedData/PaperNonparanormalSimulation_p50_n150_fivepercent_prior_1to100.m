...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n150, p50, sparsity = fivepercent
...
save('Sigma_true_n150_p50_fivepercent_1to101.mat','sigma_true');

%save the omega matrix for R
save('Omega_true_n150_p50_fivepercent_1to101.mat','omega_true');

%set the number of replications for the simulation
reps = 100;

L1_n150_p50_fivepercent = cell([reps,1]);
    SP_n150_p50_fivepercent = cell([reps,1]);
    SE_n150_p50_fivepercent = cell([reps,1]);
    MCC_n150_p50_fivepercent = cell([reps,1]);
    f_sup_n150_p50_fivepercent = cell([reps,1]);
    q_iters_n150_p50_fivepercent= cell([reps,1]);
    mean_est_n150_p50_fivepercent = cell([reps,1]);
    final_thetas_n150_p50_fivepercent = cell([reps,1]);
    burnin_theta_n150_p50_fivepercent= cell([reps,1]);
    burnin_omega_n150_p50_fivepercent = cell([reps,1]);
    y_transformed_n150_p50_fivepercent = cell([reps,1]);
    y_true_n150_p50 = cell([reps,1]);

    optimalJ_n150_p50_fivepercent = cell([reps,1]);
    minK_n150_p50_fivepercent = cell([reps,1]);
    Final_AIC_n150_p50_fivepercent = cell([reps,1]);
	total_time_n150_p50_fivepercent =  cell([reps,1]);
    

 x_matrix_n150_p50 =  cell([reps,1]);
    true_f_n150_p50 = cell([reps,1]);
    gridpoint_n150_p50 = cell([reps,1]);
    
    All_tmp_iters_n150_p50_fivepercent = cell([reps,1]);
    complete_Sig_total_sims_n150_p50_fivepercent = cell([reps,1]);
      complete_Z_total_sims_n150_p50_fivepercent = cell([reps,1]);
        complete_Omega_total_sims_n150_p50_fivepercent = cell([reps,1]);
...
MLE_norm__n150_p50 = cell([reps,1]);
    MLE_log__n150_p50 = cell([reps,1]);
    MLE_ev_n150_p50 = cell([reps,1]);
    MLE_stable_n150_p50 = cell([reps,1]);
...
for iters = 1:reps
    ...
    %Save the true y
    y_true_n150_p50{iters} = y_true;
     
   
    [x_matrix, true_f, gridpoint, MLE_norm, MLE_ev, MLE_log, MLE_stable] = xfunctions(p, y_true, n);
    
    x_matrix_n150_p50{iters} = x_matrix;
    true_f_n150_p50{iters} = true_f;
    gridpoint_n150_p50{iters} = gridpoint;
    MLE_norm__n150_p50{iters} = MLE_norm;
    MLE_log__n150_p50{iters} = MLE_log;
    MLE_ev_n150_p50{iters} = MLE_ev;
    MLE_stable_n150_p50{iters} = MLE_stable;
    

    %save the x matrix as a mat file for R
    
    save(sprintf('Bsplines_Iter_%d_x_matrix_n150_p50_fivepercent_1to100.mat', iters), 'x_matrix');
    ...
    optimalJ_n150_p50_fivepercent{iters} = optimalJ;
    minK_n150_p50_fivepercent{iters} = minK;
    Final_AIC_n150_p50_fivepercent{iters} = Final_AIC;
...
save('Bsplines_paper_Sim_n150_p50_fivepercent_prior_1to100.mat');
