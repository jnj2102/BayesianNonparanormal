...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n150, p50, sparsity = circle
...
save('Sigma_true_n150_p50_circle_1to101.mat','sigma_true');

%save the omega matrix for R
save('Omega_true_n150_p50_circle_1to101.mat','omega_true');

%set the number of replications for the simulation
reps = 100;

L1_n150_p50_circle = cell([reps,1]);
    SP_n150_p50_circle = cell([reps,1]);
    SE_n150_p50_circle = cell([reps,1]);
    MCC_n150_p50_circle = cell([reps,1]);
    f_sup_n150_p50_circle = cell([reps,1]);
    q_iters_n150_p50_circle= cell([reps,1]);
    mean_est_n150_p50_circle = cell([reps,1]);
    final_thetas_n150_p50_circle = cell([reps,1]);
    burnin_theta_n150_p50_circle= cell([reps,1]);
    burnin_omega_n150_p50_circle = cell([reps,1]);
    y_transformed_n150_p50_circle = cell([reps,1]);
    y_true_n150_p50 = cell([reps,1]);

    optimalJ_n150_p50_circle = cell([reps,1]);
    minK_n150_p50_circle = cell([reps,1]);
    Final_AIC_n150_p50_circle = cell([reps,1]);
	total_time_n150_p50_circle =  cell([reps,1]);
 ...
 x_matrix_n150_p50 =  cell([reps,1]);
    ...
    All_tmp_iters_n150_p50_circle = cell([reps,1]);
    complete_Sig_total_sims_n150_p50_circle = cell([reps,1]);
      complete_Z_total_sims_n150_p50_circle = cell([reps,1]);
        complete_Omega_total_sims_n150_p50_circle = cell([reps,1]);
...
for iters = 1:reps
    ...
    % generate the true y using the circle model
    ...
    save(sprintf('Bsplines_Iter_%d_x_matrix_n150_p50_circle_1to100.mat', iters), 'x_matrix');
    ...
    optimalJ_n150_p50_circle{iters} = optimalJ;
    minK_n150_p50_circle{iters} = minK;
    Final_AIC_n150_p50_circle{iters} = Final_AIC;
...
save('Bsplines_paper_Sim_n150_p50_circle_prior_1to100.mat');
