...
save('Sigma_true_n500_p100_twopercent_1to101.mat','sigma_true');

%save the omega matrix for R
save('Omega_true_n500_p100_twopercent_1to101.mat','omega_true');

%set the number of replications for the simulation
reps = 100;

L1_n500_p100_twopercent = cell([reps,1]);
    SP_n500_p100_twopercent = cell([reps,1]);
    SE_n500_p100_twopercent = cell([reps,1]);
    MCC_n500_p100_twopercent = cell([reps,1]);
    f_sup_n500_p100_twopercent = cell([reps,1]);
    q_iters_n500_p100_twopercent= cell([reps,1]);
    mean_est_n500_p100_twopercent = cell([reps,1]);
    final_thetas_n500_p100_twopercent = cell([reps,1]);
    burnin_theta_n500_p100_twopercent= cell([reps,1]);
    burnin_omega_n500_p100_twopercent = cell([reps,1]);
    y_transformed_n500_p100_twopercent = cell([reps,1]);
	...
	total_time_n500_p100_twopercent =  cell([reps,1]);
 ...
 x_matrix_n500_p100 =  cell([reps,1]);
    ...
    All_tmp_iters_n500_p100_twopercent = cell([reps,1]);
    complete_Sig_total_sims_n500_p100_twopercent = cell([reps,1]);
      complete_Z_total_sims_n500_p100_twopercent = cell([reps,1]);
        complete_Omega_total_sims_n500_p100_twopercent = cell([reps,1]);
...
for iters = 1:reps
    ...
    save(sprintf('Bsplines_Iter_%d_x_matrix_n500_p100_twopercent_1to100.mat', iters), 'x_matrix');
...
save('Bsplines_paper_Sim_n500_p100_twopercent_prior_1to100.mat');
