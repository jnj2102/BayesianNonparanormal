...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n50, p25, sparsity = circle
...
save('Sigma_true_n50_p25_circle_1to101.mat','sigma_true');

%save the omega matrix for R
save('Omega_true_n50_p25_circle_1to101.mat','omega_true');

%set the number of replications for the simulation
reps = 100;

L1_n50_p25_circle = cell([reps,1]);
    SP_n50_p25_circle = cell([reps,1]);
    SE_n50_p25_circle = cell([reps,1]);
    MCC_n50_p25_circle = cell([reps,1]);
    f_sup_n50_p25_circle = cell([reps,1]);
    q_iters_n50_p25_circle= cell([reps,1]);
    mean_est_n50_p25_circle = cell([reps,1]);
    final_thetas_n50_p25_circle = cell([reps,1]);
    burnin_theta_n50_p25_circle= cell([reps,1]);
    burnin_omega_n50_p25_circle = cell([reps,1]);
    y_transformed_n50_p25_circle = cell([reps,1]);
    y_true_n50_p25 = cell([reps,1]);

    optimalJ_n50_p25_circle = cell([reps,1]);
    minK_n50_p25_circle = cell([reps,1]);
    Final_AIC_n50_p25_circle = cell([reps,1]);
	total_time_n50_p25_circle =  cell([reps,1]);
    

 x_matrix_n50_p25 =  cell([reps,1]);
    true_f_n50_p25 = cell([reps,1]);
    gridpoint_n50_p25 = cell([reps,1]);
    
    All_tmp_iters_n50_p25_circle = cell([reps,1]);
    complete_Sig_total_sims_n50_p25_circle = cell([reps,1]);
      complete_Z_total_sims_n50_p25_circle = cell([reps,1]);
        complete_Omega_total_sims_n50_p25_circle = cell([reps,1]);
...
MLE_norm__n50_p25 = cell([reps,1]);
    MLE_log__n50_p25 = cell([reps,1]);
...
for iters = 1:reps
    ...
    true_f_n50_p25{iters} = true_f;
    gridpoint_n50_p25{iters} = gridpoint;
    MLE_norm__n50_p25{iters} = MLE_norm;
    MLE_log__n50_p25{iters} = MLE_log;
    ...
    save(sprintf('Bsplines_Iter_%d_x_matrix_n50_p25_circle_1to100.mat', iters), 'x_matrix');
    ...
    optimalJ_n50_p25_circle{iters} = optimalJ;
    minK_n50_p25_circle{iters} = minK;
    Final_AIC_n50_p25_circle{iters} = Final_AIC;
...
save('Bsplines_paper_Sim_n50_p25_circle_prior_1to100.mat');
