...
%save('PaperCholeskyDecomp_Sigma_true_p100_n500_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p100_n500_circle_xmat.mat','omega_true');
...
for iters = 1:reps
    ...
    power_n500_p100{iters} = power;
    MLE_norm_n500_p100{iters} = MLE_norm;
...
save('BayesNonpar_p100_n500_circle_prior.mat');
