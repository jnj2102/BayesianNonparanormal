...
%save('PaperCholeskyDecomp_Sigma_true_p100_n500_AR1_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p100_n500_AR1_xmat.mat','omega_true');
...
save('BayesNonpar_p100_n500_AR1_prior.mat');
