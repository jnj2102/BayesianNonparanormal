...
%save('PaperCholeskyDecomp_Sigma_true_p25_n50_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p25_n50_circle_xmat.mat','omega_true');
...
save('BayesNonpar_p25_n50_circle_prior.mat');
