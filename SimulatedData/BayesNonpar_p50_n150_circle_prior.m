...
%save('PaperCholeskyDecomp_Sigma_true_p50_n150_circle_xmat.mat','sigma_true');

%save the omega matrix for R
%save('PaperCholeskyDecomp_Omega_true_p50_n150_circle_xmat.mat','omega_true');
...
Z_two_cell_iters = cell([reps,1]);
    ...
    MLE_log_n150_p50 = cell([reps,1]);
MLE_norm_n150_p50 = cell([reps,1]);
    MLE_ev_n150_p50 = cell([reps,1]);
    MLE_stable_n150_p50 = cell([reps,1]);
    power_n150_p50 = cell([reps,1]);
...
for iters = 1:reps
    ...
    MLE_log_n150_p50{iters} = MLE_log;
    power_n150_p50{iters} = power;
    MLE_norm_n150_p50{iters} = MLE_norm;
...
save('BayesNonpar_p50_n150_circle_prior.mat');
