...
load('Bsplines_paper_n500_p100_AR1_SpikeSlab_1to100_91to100.mat');
...
for iters = 91:100
   ...
   fprintf('Iterations = %d', iters);
    ...
    for c_index = 1:num_elements1
        ...
        Omega_L1_SSVS = Omega_L1_SSVS_n500_p100_AR1{c_index, ab_index,iters};
        
        edge_matrix_ssvs = edge_matrix_n500_p100_AR1{c_index, ab_index,iters};
        
       complete_Z_Bayes_est_sims = complete_Z_Bayes_est_sims_n500_p100_AR1{c_index, ab_index,iters};
...
eBIC_matrix_finalanalysis(iters) =     eBIC_matrix(rowMinBIC, colMinBIC,iters);
 ...
 total_time_n500_p100_AR1_finalanalysis(iters) =   total_time_n500_p100_AR1(rowMinBIC, colMinBIC,iters);

 edge_matrix_n500_p100_AR1_finalanalysis{iters} =   edge_matrix_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
Omega_L1_SSVS_n500_p100_AR1_finalanalysis{iters} = Omega_L1_SSVS_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   q_iters_n500_p100_AR1_finalanalysis(iters) =  q_iters_n500_p100_AR1(rowMinBIC, colMinBIC,iters);
   final_thetas_n500_p100_AR1_finalanalysis{iters} =  final_thetas_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   final_mean_n500_p100_AR1_finalanalysis{iters} = final_mean_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
    burnin_n500_p100_AR1_finalanalysis(iters) = burnin_n500_p100_AR1(rowMinBIC, colMinBIC,iters);
   y_transformed_n500_p100_AR1_finalanalysis{iters} = y_transformed_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   All_tmp_iters_n500_p100_AR1_finalanalysis{iters} =  All_tmp_iters_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  complete_Sig_total_sims_n500_p100_AR1_finalanalysis{iters} =  complete_Sig_total_sims_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   complete_Z_total_sims_n500_p100_AR1_finalanalysis{iters} =  complete_edge_matrix_total_sims_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  complete_Omega_total_sims_n500_p100_AR1_finalanalysis{iters} =   complete_Omega_total_sims_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
complete_Z_Bayes_est_sims_n500_p100_AR1_finalanalysis{iters} = complete_Z_Bayes_est_sims_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   TP_SSVS_n500_p100_AR1_finalanalysis(iters) =  TP_SSVS_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  TN_SSVS_n500_p100_AR1_finalanalysis(iters) =  TN_SSVS_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  FP_SSVS_n500_p100_AR1_finalanalysis(iters) =  FP_SSVS_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
   FN_SSVS_n500_p100_AR1_finalanalysis(iters) = FN_SSVS_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  allOmega_n500_p100_AR1_finalanalysis{iters} =  allOmega_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  allSig_n500_p100_AR1_finalanalysis{iters} =   allSig_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  monitor_omega_chain_firsthalf_n500_p100_AR1_finalanalysis{iters} =  monitor_omega_chain_firsthalf_n500_p100_AR1{rowMinBIC, colMinBIC,iters};
  monitor_omega_chain_secondhalf_n500_p100_AR1_finalanalysis{iters} =  monitor_omega_chain_secondhalf_n500_p100_AR1{rowMinBIC, colMinBIC,iters};



end

save('BayesNonpar_Sim_n500_p100_AR1_SS_1to100_91to100_final.mat', '-v7.3');
