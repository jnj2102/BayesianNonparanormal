...
load('BayesNonpar_p50_n150_AR1_prior.mat');
 ...
 [num_elements2, ~] = size(fg_cell);
    ...
    Sigma_Bayes_est_n150_p50_AR1 = cell([num_elements1,num_elements2, reps]);
    Omega_Bayes_est_n150_p50_AR1 = cell([num_elements1,num_elements2, reps]);
    edge_matrix_n150_p50_AR1 = cell([num_elements1,num_elements2, reps]);
        
      entropy_loss_matrix=  zeros(num_elements1,num_elements2, reps);
    bounded_loss_n150_p50_AR1 =  zeros(num_elements1,num_elements2, reps);
      Frobenius_norm_precision_n150_p50_AR1 =  zeros(num_elements1,num_elements2, reps);
   Frobenius_norm_covariance_n150_p50_AR1 =  zeros(num_elements1,num_elements2, reps);
    ...
    mean_Z_Bayes_est_n150_p50_AR1 = cell([num_elements1,num_elements2, reps]);
...
%save all of the data for each hyperparameter setting.
    ...
    bounded_loss_n150_p50_AR1(c_index, fg_index,iters) = bounded_loss; 
   Frobenius_norm_precision_n150_p50_AR1(c_index, fg_index,iters) = Frobenius_norm_precision; 
   Frobenius_norm_covariance_n150_p50_AR1(c_index, fg_index,iters) = Frobenius_norm_covariance; 
   ...
   total_time_n150_p50_AR1(c_index, fg_index,iters) = total_time; %this is the
        %total time it took to run the sampling using q_iters

    edge_matrix_n150_p50_AR1{c_index, fg_index,iters} = edge_matrix_ssvs;

    Sigma_Bayes_est_n150_p50_AR1{c_index, fg_index,iters} = Sigma_Bayes_est;
    Omega_Bayes_est_n150_p50_AR1{c_index, fg_index,iters} = Omega_Bayes_est;
    mean_Z_Bayes_est_n150_p50_AR1{c_index, fg_index,iters} = mean_Z_Bayes_est;
    TP_SSVS_n150_p50_AR1{c_index, fg_index,iters} = TP_SSVS;
    TN_SSVS_n150_p50_AR1{c_index, fg_index,iters} = TN_SSVS;
    FP_SSVS_n150_p50_AR1{c_index, fg_index,iters} = FP_SSVS;
    FN_SSVS_n150_p50_AR1{c_index, fg_index,iters} = FN_SSVS;
...
save('BayesNonpar_p50_n150_AR1_SpikeSlab_76to100_parallel.mat', '-v7.3');
