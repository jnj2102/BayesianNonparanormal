...
L1_freq_n150_p50_fivepercent_ebic <- c()
SP_freq_n150_p50_fivepercent_ebic <- c()
SE_freq_n150_p50_fivepercent_ebic <- c()
MCC_freq_n150_p50_fivepercent_ebic <- c()
ans_final_ebic <- list()
TP_ebic <- c()
TN_ebic <- c()
FP_ebic <- c()
...
L1_freq_n150_p50_fivepercent_stars <- c()
SP_freq_n150_p50_fivepercent_stars <- c()
SE_freq_n150_p50_fivepercent_stars <- c()
MCC_freq_n150_p50_fivepercent_stars <- c()
...
L1_freq_n150_p50_fivepercent_stars_alternative <- c()
SP_freq_n150_p50_fivepercent_stars_alternative <- c()
SE_freq_n150_p50_fivepercent_stars_alternative <- c()
MCC_freq_n150_p50_fivepercent_stars_alternative <- c()
...
L1_freq_n150_p50_fivepercent_ric <- c()
SP_freq_n150_p50_fivepercent_ric <- c()
SE_freq_n150_p50_fivepercent_ric <- c()
MCC_freq_n150_p50_fivepercent_ric <- c()
ans_final_ric <- list()
TP_ric <- c()
TN_ric <- c()
FP_ric <- c()
...
#Run this in a loop for each iteration 
  ...
  sigma_true <- readMat('Sigma_true_n150_p50_fivepercent_1to101.mat',
  ...
  omega_true <- readMat('Omega_true_n150_p50_fivepercent_1to101.mat', package = R.matlab)$omega.true
...
xmat <- readMat(sprintf("Bsplines_Iter_%d_x_matrix_n150_p50_fivepercent_1to100.mat", iters), 
...
L1_freq_n150_p50_fivepercent_ebic[iters] = sum(diag(solve(opt_covarianceMat_ebic) %*% sigma_true)) -
...
SP_freq_n150_p50_fivepercent_ebic[iters] = TN_ebic[iters]/(TN_ebic[iters] + FP_ebic[iters])

SE_freq_n150_p50_fivepercent_ebic[iters] = TP_ebic[iters]/(TP_ebic[iters] + FN_ebic[iters])
...
MCC_freq_n150_p50_fivepercent_ebic[iters] = ((TP_ebic[iters] * TN_ebic[iters]) -
...
L1_freq_n150_p50_fivepercent_stars[iters] = sum(diag(solve(opt_covarianceMat_stars) %*% sigma_true)) -
...
SP_freq_n150_p50_fivepercent_stars[iters] = TN_stars[iters]/(TN_stars[iters] + FP_stars[iters])

SE_freq_n150_p50_fivepercent_stars[iters] = TP_stars[iters]/(TP_stars[iters] + FN_stars[iters])
...
MCC_freq_n150_p50_fivepercent_stars[iters] = ((TP_stars[iters] * TN_stars[iters]) -
...
L1_freq_n150_p50_fivepercent_stars_alternative[iters] = sum(diag(solve(opt_covarianceMat_stars_alternative) %*% sigma_true)) -
...
SP_freq_n150_p50_fivepercent_stars_alternative[iters] = TN_stars_alternative[iters]/(TN_stars_alternative[iters] + FP_stars_alternative[iters])

SE_freq_n150_p50_fivepercent_stars_alternative[iters] = TP_stars_alternative[iters]/(TP_stars_alternative[iters] + FN_stars_alternative[iters])
...
MCC_freq_n150_p50_fivepercent_stars_alternative[iters] = ((TP_stars_alternative[iters] * TN_stars_alternative[iters]) -
...
L1_freq_n150_p50_fivepercent_ric[iters] = sum(diag(solve(opt_covarianceMat_ric) %*% sigma_true)) -
...
SP_freq_n150_p50_fivepercent_ric[iters] = TN_ric[iters]/(TN_ric[iters] + FP_ric[iters])

SE_freq_n150_p50_fivepercent_ric[iters] = TP_ric[iters]/(TP_ric[iters] + FN_ric[iters])
...
MCC_freq_n150_p50_fivepercent_ric[iters] = ((TP_ric[iters] * TN_ric[iters]) -
...
#Find the means 
mean_L1_freq_n150_p50_fivepercent_ebic = mean(L1_freq_n150_p50_fivepercent_ebic)
mean_SP_freq_n150_p50_fivepercent_ebic = mean(SP_freq_n150_p50_fivepercent_ebic)
mean_SE_freq_n150_p50_fivepercent_ebic = mean(SE_freq_n150_p50_fivepercent_ebic)

#I removed the NAs for MCC

mean_MCC_freq_n150_p50_fivepercent_ebic = mean(MCC_freq_n150_p50_fivepercent_ebic, na.rm = TRUE)  

#Find the standard errors

stderr_L1_freq_n150_p50_fivepercent_ebic = stderr(L1_freq_n150_p50_fivepercent_ebic)
stderr_SP_freq_n150_p50_fivepercent_ebic = stderr(SP_freq_n150_p50_fivepercent_ebic)
stderr_SE_freq_n150_p50_fivepercent_ebic = stderr(SE_freq_n150_p50_fivepercent_ebic)
stderr_MCC_freq_n150_p50_fivepercent_ebic = stderr(MCC_freq_n150_p50_fivepercent_ebic)

###  For STARS Model Selection using Threshold = .1####

#Find the means 
mean_L1_freq_n150_p50_fivepercent_stars = mean(L1_freq_n150_p50_fivepercent_stars)
mean_SP_freq_n150_p50_fivepercent_stars = mean(SP_freq_n150_p50_fivepercent_stars)
mean_SE_freq_n150_p50_fivepercent_stars = mean(SE_freq_n150_p50_fivepercent_stars)

#I removed the NAs for MCC

mean_MCC_freq_n150_p50_fivepercent_stars = mean(MCC_freq_n150_p50_fivepercent_stars, na.rm = TRUE)  

#Find the standard errors

stderr_L1_freq_n150_p50_fivepercent_stars = stderr(L1_freq_n150_p50_fivepercent_stars)
stderr_SP_freq_n150_p50_fivepercent_stars = stderr(SP_freq_n150_p50_fivepercent_stars)
stderr_SE_freq_n150_p50_fivepercent_stars = stderr(SE_freq_n150_p50_fivepercent_stars)
stderr_MCC_freq_n150_p50_fivepercent_stars = stderr(MCC_freq_n150_p50_fivepercent_stars)


###  For STARS Model Selection using Threshold = .05####

#Find the means 
mean_L1_freq_n150_p50_fivepercent_stars_alternative = mean(L1_freq_n150_p50_fivepercent_stars_alternative)
mean_SP_freq_n150_p50_fivepercent_stars_alternative = mean(SP_freq_n150_p50_fivepercent_stars_alternative)
mean_SE_freq_n150_p50_fivepercent_stars_alternative = mean(SE_freq_n150_p50_fivepercent_stars_alternative)

#I removed the NAs for MCC

mean_MCC_freq_n150_p50_fivepercent_stars_alternative = mean(MCC_freq_n150_p50_fivepercent_stars_alternative, na.rm = TRUE)  

#Find the standard errors

stderr_L1_freq_n150_p50_fivepercent_stars_alternative = stderr(L1_freq_n150_p50_fivepercent_stars_alternative)
stderr_SP_freq_n150_p50_fivepercent_stars_alternative = stderr(SP_freq_n150_p50_fivepercent_stars_alternative)
stderr_SE_freq_n150_p50_fivepercent_stars_alternative = stderr(SE_freq_n150_p50_fivepercent_stars_alternative)
stderr_MCC_freq_n150_p50_fivepercent_stars_alternative = stderr(MCC_freq_n150_p50_fivepercent_stars_alternative)

###  For RIC Model Selection ####

#Find the means 
mean_L1_freq_n150_p50_fivepercent_ric = mean(L1_freq_n150_p50_fivepercent_ric)
mean_SP_freq_n150_p50_fivepercent_ric = mean(SP_freq_n150_p50_fivepercent_ric)
mean_SE_freq_n150_p50_fivepercent_ric = mean(SE_freq_n150_p50_fivepercent_ric)

#I removed the NAs for MCC

mean_MCC_freq_n150_p50_fivepercent_ric = mean(MCC_freq_n150_p50_fivepercent_ric, na.rm = TRUE)  

#Find the standard errors

stderr_L1_freq_n150_p50_fivepercent_ric = stderr(L1_freq_n150_p50_fivepercent_ric)
stderr_SP_freq_n150_p50_fivepercent_ric = stderr(SP_freq_n150_p50_fivepercent_ric)
stderr_SE_freq_n150_p50_fivepercent_ric = stderr(SE_freq_n150_p50_fivepercent_ric)
stderr_MCC_freq_n150_p50_fivepercent_ric = stderr(MCC_freq_n150_p50_fivepercent_ric)

###################################################################

#Save the data for latex later

save.image(file = "Bsplines_paper_frequentist_p50_n150_fivepercent.rdata")
