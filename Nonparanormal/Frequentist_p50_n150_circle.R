...
data <- readMat('BayesNonpar_p50_n150_circle_prior.mat', package = "R.matlab") #Read in all the data
...
#Run this in a loop for each iteration 
  ...
  xmat <- data$x.matrix.n150.p50[[iters]][[1]]
...
save.image(file = "Frequentist_p50_n150_circle.rdata")
